				...
				<ul class="nav">
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							...
							<li><a href="../material/index_v2.html">MATERIAL DESIGN</a></li>
							<li><a href="../apple/index_v2.html">APPLE DESIGN</a></li>
							<li><a href="../transparent/index_v2.html">TRANSPARENT DESIGN <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
