	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown navbar-user">
			<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
				...
				<span class="d-none d-md-inline"><?=$this->ion_auth->user()->row()->first_name?></span> <b class="caret"></b>
			</a>
			<div class="dropdown-menu dropdown-menu-right">
				<a href="auth/edit_user/<?=$this->ion_auth->user()->row()->id?>" class="dropdown-item">Edit Profile</a>
