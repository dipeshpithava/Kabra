...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->breadcrumbs->unshift('Dashboard', '/dashboard');
	...
	{
		$this->breadcrumbs->push('Users', '/');
		$this->breadcrumbs->push('Users/Change Passwor', '/auth/change_password');
		$this->breadcrumbs->unshift('Dashboard', '/dashboard');
	...
	{
		$this->breadcrumbs->push('Users', '/');
		$this->breadcrumbs->push('Users/Forgot Passwor', '/auth/forgot_password');
		$this->breadcrumbs->unshift('Dashboard', '/dashboard');
	...
	{
		$this->breadcrumbs->push('Users', '/');
		$this->breadcrumbs->push('Users/Reset Passwor', '/auth/reset_password');
		$this->breadcrumbs->unshift('Dashboard', '/dashboard');
		if (!$code)
		{
			show_404();
